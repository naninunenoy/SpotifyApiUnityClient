...
namespace n5y.SpotifyApi {
    public static partial class Api {
        ...
        public static async UniTask PostQueueAsync(string uri, ITokenProvider token,
        ...
        public static async UniTask<DeviceListModel> GetDevicesAsync(ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask<PlayerModel> GetPlayerAsync(ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask PutPlayerAsync(string deviceId, ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask<RecentlyPlayedTrackModel> GetRecentlyPlayedAsync(ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask<CurrentlyPlayingTrackModel> GetCurrentlyPlayingAsync(ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask PutSeekAsync(int positionMs, ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask PutRepeatAsync(RepeatState repeatState, ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask PutVolumeAsync(int volumePercent, ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask PutPlayAsync(string contextUri, ITokenProvider token,
            CancellationToken cancellationToken) {
        ...
        public static async UniTask PutShuffleAsync(bool shuffle, ITokenProvider token,
            CancellationToken cancellationToken) {
